...
public final class OverlayService extends Service {
    ...
    public void onCreate() {
        ...
        layoutView = inflater.inflate(R.layout.flation_overlayer_menu, null);
        windowManager.addView(layoutView, params);

        final ImageButton button = layoutView.findViewById(R.id.toggle);
        clickListener = view -> {


            Toast.makeText(view.getContext(),"Button is Clicked!" ,Toast.LENGTH_LONG).show();
//            try {
...
//            }
        ...
        layoutView.setOnTouchListener((view, arg1) -> false);
